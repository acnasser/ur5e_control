...
def main():
    ...
    while not rospy.is_shutdown():
        if len(points_in_camera) != 0:
            ...
            print(points_in_base)
           
            plan_point5 = Twist()
            plan_point5.linear.x = points_in_base.point.x + 0.06
            plan_point5.linear.y = points_in_base.point.y
            plan_point5.linear.z = points_in_base.point.z
            ...
            plan_point3.linear.y = .3
            plan_point3.linear.z = 0.4
